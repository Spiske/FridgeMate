...
"ANTIALIASED";
/** @hidden */
export declare const OutputModeValues: ReadonlyArray<OutputMode>;
/**
...
"PRESET_5";
/** @hidden */
export declare const BinarizationFilterPresetValues: ReadonlyArray<BinarizationFilterPreset>;
/**
...
Automatic binarization filter. This filter is a good starting point for most use cases.
*/
export declare class CustomBinarizationFilter {
...
*/
export declare class ContrastFilter {
...
*/
export declare class GrayscaleFilter {
...
are linearly scaled.
*/
export declare class WhiteBlackPointFilter {
...
"ENABLED_IF_BINARIZATION_FILTER_SET";
/** @hidden */
export declare const PageBinarizationValues: ReadonlyArray<PageBinarization>;
