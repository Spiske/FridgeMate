...
*/
export type VinBarcodeExtractionStatus = 
/**
Barcode containing a VIN was successfully extracted.
*/
"SUCCESS" | 
...
"BARCODE_EXTRACTION_DISABLED";
/** @hidden */
export declare const VinBarcodeExtractionStatusValues: ReadonlyArray<VinBarcodeExtractionStatus>;
/**
Result of the barcode scanner.
*/
export declare class VinBarcodeResult {
    /**
...
*/
export declare class VinScannerResult {
    /**
