...
*/
export type DocumentScannerEngineMode = 
/**
Use the ML document scanner.
*/
"ML" | 
...
"LEGACY";
/** @hidden */
export declare const DocumentScannerEngineModeValues: ReadonlyArray<DocumentScannerEngineMode>;
/**
Parameters for the document scanner.
*/
export declare class DocumentScannerParameters {
    /**
...
*/
export declare class PartiallyVisibleDocumentConfiguration {
    /**
    ...
    */
    ...
    constructor(source?: DeepPartial<PartiallyVisibleDocumentConfiguration>);
}
/**
Configuration for the document scanner.
*/
export declare class DocumentScannerConfiguration {
    /**
    ...
    */
    ...
    /**
    Configuration for handling partially visible documents.
    @defaultValue new PartiallyVisibleDocumentConfiguration({});
    */
...
"UPPER_LEFT";
/** @hidden */
export declare const DocumentDisplacementValues: ReadonlyArray<DocumentDisplacement>;
/**
...
"ERROR_TOO_NOISY";
/** @hidden */
export declare const DocumentDetectionStatusValues: ReadonlyArray<DocumentDetectionStatus>;
/**
The total and partial scores for the detected document contour.
*/
export declare class DocumentDetectionScores {
    /**
...
*/
export declare class DocumentDetectionResult {
    /**
    Detection status.
...
*/
export declare class DocumentScanningResult {
    /**
    Result of the document contour detection
    */
