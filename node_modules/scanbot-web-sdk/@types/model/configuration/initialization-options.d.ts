...
export interface InitializationOptions {
    ...
    /**
     * The completion handler is called when deferred initialization is complete, i.e. when the WASM binary has been loaded.
     * This will only be called after the SDK has been successfully initialized or if an error occurred,
     * in which case the error parameter will be evaluated, otherwise undefined.
     */
    onComplete?: (e?: Error) => void;
}
