...
import { DocumentDetectionStatus, DocumentScannerConfiguration, DocumentScannerScanResponse } from "../../core-types";
...
export declare class DocumentScannerViewConfiguration extends ScannerConfiguration {
    constructor();
    /** {@displayType `DeepPartial<DocumentScannerConfiguration>`} {@link DocumentScannerConfiguration}*/
     ...
     */
    onDocumentDetected?: (result: DocumentScannerScanResponse) => void;
